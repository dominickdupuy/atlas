...
from atlas.approvals.domain.approval import Approval, ApprovalState
from atlas.connectors.domain.tools import ToolResult
from atlas.jobs.domain.run import ProposedAction
from atlas.shared.ids import ApprovalId, JobId
