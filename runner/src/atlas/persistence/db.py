...
def _load_migrations() -> list[tuple[int, str, str]]:
    ...
    package = resources.files("atlas.persistence") / "migrations"
    ...
    found.sort()
    if not found:
        raise RuntimeError("no migrations found in atlas.persistence.migrations")
    return found
...
class Database:
    ...
    async def migrate(self) -> list[str]:
        ...
        Runs at startup and via `atlas migrate`."""
