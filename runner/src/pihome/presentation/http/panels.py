...
from pihome.budget.domain.ledger import format_usd
from pihome.jobs.domain.events import JobRunEvent
from pihome.shared.events import DomainEvent
from pihome.telemetry.domain.topics import DisplayModeChanged, SystemHealth
...
class PanelRenderer:
    def __init__(self, application: Application) -> None:
        ...
        self._env = Environment(
            loader=PackageLoader("pihome.presentation", "templates"),
