"""The child side of the D14 protocol: what `pihome execute-job` runs.
...
from pihome.jobs.domain.run import RunReport, RunRequest
...
async def run_child(request: RunRequest) -> RunReport:
    ...
    from pihome.bootstrap.child import build_tier_executor
